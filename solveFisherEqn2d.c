...
double Ui(double x, double y, double t)
{
	...
	double eta = (d[0] * (x - cx) + d[1] * (y - cy) - t) / _epsilon;
...
int main (int argc, char* argv[])
{
  ...
  mgl::createWindow(800, 800, "Fisher equation"); 
