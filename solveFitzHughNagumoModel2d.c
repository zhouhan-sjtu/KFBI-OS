/*=============================================================================
*   
*   Filename : solveFitzHughNagumoModel2d.c
*   Creator : Han Zhou
*   Date : 11/22/21
*   Description : 
*
...
static const double H_const = 100.0; 
static const double theta_const = 0.25; 
static const double alpha_const = 0.15; 
static const double beta_const = 1.0;

static const double eps_const = 0.01;
...
double U(double x, double y, double t)
{
  ...
  double xi = 20.0 * (r - 0.1);
  //double xi = -50.0 * (r - 0.1);
  double u = 1.0 / (1.0 + exp(xi));
	return u;
}
...
void startSolvingPDE(void)
{
  const double ctrl_node[28][2] = {
	...
	//curve.setShape(1.1, 1.1, 0.3, M_PI/2.0, 5.0);
	//curve.setShape(1.2*0.85, 1.2*0.85, 1.2*0.15, 0.0, 4.0);

	//curve.setShape(-0.1, 0.2, 0.7, 0.5, M_PI/3.0);
	//curve.setShape(0.0, 0.0, 1.3, 0.9, 0.0);
	//curve.setShape(0.0, 0.0, 1.3, 1.0, 0.0);
	...
	//solver.setCoefficient(eps_const, -H_const, theta_const, alpha_const, beta_const);
...
int main (int argc, char* argv[])
{
  ...
  mgl::createWindow(800, 800, "FitzHugh Nagumo model"); 
